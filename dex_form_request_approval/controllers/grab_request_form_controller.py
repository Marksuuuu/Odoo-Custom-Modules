...
class GrabRequestFormController(http.Controller):
    @http.route('/dex_form_request_approval/request/grf_approve/<string:token>', type='http', auth='public', website=True)
    def itrf_approval(self, token):
        request_form = request.env['grab.request.form'].sudo().search([('approval_link', '=', token)])
        if request_form:
    ...
    @http.route('/dex_form_request_approval/request/grf_disapprove/<string:token>', type='http', auth='public',
                website=True,
                csrf=False,
                method=['GET', 'POST'])
    def itrf_disapproval(self, token, **post):
        request_form = request.env['grab.request.form'].sudo().search([('approval_link', '=', token)])
        if request_form:
    ...
    @http.route('/dex_form_request_approval/request/grf_dashboard/<string:token>', type='http', auth='public', website=True)
    def itrf_dashboard(self, token):
        request_form = request.env['grab.request.form'].sudo().search([('approval_link', '=', token)])
