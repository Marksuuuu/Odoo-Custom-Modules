...
class ItRequestFormController(http.Controller):
    @http.route('/dex_form_request_approval/request/irf_approve/<string:token>', type='http', auth='public', website=True)
    def itrf_approval(self, token):
        request_form = request.env['it.request.form'].sudo().search([('approval_link', '=', token)])
        if request_form:
    ...
    @http.route('/dex_form_request_approval/request/irf_disapprove/<string:token>', type='http', auth='public',
                website=True,
                csrf=False,
                method=['GET', 'POST'])
    ...
    @http.route('/dex_form_request_approval/request/irf_dashboard/<string:token>', type='http', auth='public', website=True)
