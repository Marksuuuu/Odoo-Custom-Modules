...
class Service(models.Model):
    ...
    def client_search(self):
        action = {
            ...
            'res_model': 'dex_service.client.search',
            'view_mode': 'form',
            'target': 'new',
            'domain': [],
            'context': { }
    ...
    def block_client(self):
        action = {
            'name': 'Block Client?',
            'type': 'ir.actions.act_window',
            'res_model': 'dex_service.block.reason',
            'view_mode': 'form',
            'target': 'new',
            'domain': [],
            'context': {
    ...
    def create_ticket_by(self, request_type, type, what_type):
        action = {
            ...
            'type': 'ir.actions.act_window',
            'res_model': 'dex_service.create.ticket.by',
            'view_mode': 'form',
            'target': 'new',
            'domain': [],
            'context': {
    ...
    def transfer_to(self):
        action = {
            ...
            'type': 'ir.actions.act_window',
            'res_model': 'dex_service.transfer.to',
            'view_mode': 'form',
            'target': 'new',
            'domain': [],
            'context': {
    ...
    def assign_workers(self):
        for record in self:
            ...
            action = {
                'name': 'Assign Workers',
                'type': 'ir.actions.act_window',
                'res_model': 'dex_service.assign.request',
                'view_mode': 'tree,form',
                # 'view_id': view_id,
                'target': 'current',
    ...
    def show_thread(self):
        for record in self:
            ...
            action = {
                'name': 'Create Thread',
                'type': 'ir.actions.act_window',
                'res_model': 'dex_service.service.line.thread',
                'view_mode': 'tree,form',
                'target': 'current',
    ...
    def create_thread(self):
        for record in self:
            ...
            action = {
                'name': 'Create Thread',
                'type': 'ir.actions.act_window',
                'res_model': 'dex_service.create.thread.wizard',
                # 'views': [(view_id, 'form')],
                'view_mode': 'form',
                'target': 'new',
                'context': {
                    ...
                    'default_warranty_number': self.warranty_number.id,
                    'default_serial_number': self.serial_number,
                    'default_pending_reason': self.pending_reason,
                }
            }
            return action
