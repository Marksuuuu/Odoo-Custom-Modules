...
class DexServiceAddService(models.TransientModel):
    ...
    def btn_save_changes(self):
        ...
        if self.service_id.service_line_main_ids.is_inputs_complete:
            ...
            raise UserError(f'Please Contact {requests_res.service_id.service_line_main_ids.create_uid.name} to Finish/To Fully Filled this Fields (Pending Reason, Tentative Date, Contact/Phone Number), Thank you')
