...
class DexServiceCreateThreadWizard(models.TransientModel):
    _name = 'dex_service.create.thread.wizard'
    ...
    def create_thread(self):
        thread_vals = {
            ...
            'warranty_number': self.warranty_number.id,
        ...
        self.env['dex_service.service.line.thread'].create(thread_vals)
        return True
